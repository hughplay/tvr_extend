...
class TRANCEDataModule(LightningDataModule):
    ...
    def train_dataloader(self):
        train_dataset = self.data_cls(
            ...
            move_out_aug=self.move_out_aug, **self.kwargs)
    ...
    def val_dataloader(self):
        val_dataset = self.data_cls(
            split='val', img_aug=False, move_out_aug=False, **self.kwargs)
    ...
    def test_dataloader(self):
        test_dataset = self.data_cls(
            split='test', img_aug=False, move_out_aug=False, **self.kwargs)
